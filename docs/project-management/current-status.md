...
Current stack, architecture, API contract, and validation/release summaries live in
...
- Current companion docs now define stack, architecture, API contract, validation, and release boundaries; they must be updated when package scripts, runtime config, API route families, response/auth contracts, data chain, or gate behavior changes.
...
- Keep current stack, architecture, API contract, validation, and release summaries aligned with code and workflow changes.
