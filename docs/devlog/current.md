...
- Current task audited `docs/project-governance/` workflow documents and updated progress-control entrypoints; it is closed for commit.
...
- For progress control, start from `docs/project-governance/current/PROJECT_CONTROL.md` and `docs/project-management/current-status.md`.
