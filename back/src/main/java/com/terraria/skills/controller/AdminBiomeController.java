...
public class AdminBiomeController {
    ...
    private void applyBiomeFields(Biome biome, AdminBiomeUpsertRequestDTO request, boolean creating) {
        ...
        if (request.getWikiGroupCode() != null) biome.setWikiGroupCode(AdminTextUtils.trimToNullUnicodeBlank(request.getWikiGroupCode()));
        if (request.getWikiGroupNameEn() != null) biome.setWikiGroupNameEn(AdminTextUtils.trimToNullUnicodeBlank(request.getWikiGroupNameEn()));
        if (request.getWikiGroupNameZh() != null) biome.setWikiGroupNameZh(AdminTextUtils.trimToNullUnicodeBlank(request.getWikiGroupNameZh()));
        if (request.getWikiParentGroupCode() != null) biome.setWikiParentGroupCode(AdminTextUtils.trimToNullUnicodeBlank(request.getWikiParentGroupCode()));
        if (request.getWikiParentGroupNameEn() != null) biome.setWikiParentGroupNameEn(AdminTextUtils.trimToNullUnicodeBlank(request.getWikiParentGroupNameEn()));
        if (request.getWikiParentGroupNameZh() != null) biome.setWikiParentGroupNameZh(AdminTextUtils.trimToNullUnicodeBlank(request.getWikiParentGroupNameZh()));
        ...
        if (request.getWikiSectionAnchor() != null) biome.setWikiSectionAnchor(AdminTextUtils.trimToNullUnicodeBlank(request.getWikiSectionAnchor()));
