...
const requiredPublicDataLayerFiles = [
  ...
  'utils/price.ts',
  'utils/previewImageVisibleCenter.ts',
...
for (const path of scanFiles) {
  ...
  if (path === 'pages/biomes/index.vue') {
    for (const marker of [
      ...
      'biome-environment-map-frame',
      'biome-environment-map-image',
      'biome-tile-art',
      'biome-tile-backdrop',
      'biome-tile-thumb',
      'biome-tile-title',
  ...
  if (path === 'assets/css/hifi-preview.css') {
    for (const marker of [
      ...
      '.biome-environment-map-frame',
      '.biome-environment-map-image',
      '.biome-detail-environment-hero',
      '.biome-detail-environment-bg',
      '.biome-detail-environment-scan',
      '.biome-filter-strip',
      '.biome-feature-grid',
      '.biome-list-grid',
      '.biome-tile-facts',
