    ...
    <main class="boss-page-shell">
      ...
      <section class="boss-timeline" aria-label="Boss 推进线">
        ...
        <article class="boss-node">
          <i><img src="http://localhost:9000/terrapedia-images/npcs/2026/05/08/17ee52151e494ffdab942e0b1cbe2586.png" alt="骷髅王" /></i>
          <span>地牢入口</span>
          <h3>骷髅王</h3>
        ...
        <article class="boss-node hardmode">
          <i><img src="http://localhost:9000/terrapedia-images/npcs/2026/05/08/598625b6363f403c90a90a4af9145b96.gif" alt="血肉墙" /></i>
          <span>世界转折</span>
          <h3>血肉墙</h3>
      ...
      <section class="boss-lower-grid">
        <article class="boss-feature-panel">
          ...
          <div class="moon-stage">
            <img src="http://localhost:9000/terrapedia-images/npcs/2026/05/08/f019c588f5fb462087ed61eb12d3c9ea.gif" alt="月亮领主" />
          </div>
          <h3>月亮领主</h3>
