...
const hotSearches = [
  { title: '泰拉刃', meta: '合成目标', href: '/search-tool?keyword=泰拉刃' },
  { title: '甲虫套', meta: '近战防具', href: '/search-tool?keyword=甲虫套' },
  { title: '铁皮药水', meta: '防御增益', href: '/search-tool?keyword=铁皮药水' },
  { title: '翅膀', meta: '移动配饰', href: '/search-tool?keyword=翅膀' },
  { title: '月亮领主', meta: '后期 Boss', href: '/search-tool?keyword=月亮领主' },
]
...
useSeoMeta({
  title: 'TerraPedia · 搜索备选',
  description: '保留的新搜索工具入口，用于对照搜索体验。',
})
</script>
