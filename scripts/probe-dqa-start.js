...
const resultPath = 'G:/ClaudeCode/terraPedia-db-redesign/reports/dqa-probe-result.json';
const cmd = 'pnpm.cmd';
...
const append = (d) => { logs += d.toString(); if (logs.length > 16000) logs = logs.slice(-16000); };
