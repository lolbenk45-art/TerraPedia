...
const checks = [
  ...
  { name: 'admin.armorSets.detail', path: '/admin/armor-sets/1', method: 'GET', auth: true, expectStatus: 200 },
  { name: 'admin.storage.sync.dryRun', path: '/admin/storage/wiki-images/sync', method: 'POST', auth: true, expectStatus: 200, body: { limit: 1, force: false, includeItemImages: false, includeBuffs: false, includeBiomes: false } },
];
