...
const resultPath = 'G:/ClaudeCode/terraPedia-db-redesign/reports/back-probe-result.json';
const cmd = 'mvn.cmd';
const args = ['-DskipTests', 'spring-boot:run'];
const cwd = 'G:/ClaudeCode/terraPedia-db-redesign/back';
const timeoutMs = 120000;
const repoRoot = 'G:/ClaudeCode/terraPedia-db-redesign';
...
function requireTextSetting(name, value) {
