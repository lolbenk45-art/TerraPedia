...
const resultPath = 'G:/ClaudeCode/terraPedia-db-redesign/reports/dqa-link-probe-result.json';
const cmd = 'pnpm.cmd';
const args = ['run','dev'];
const cwd = 'G:/ClaudeCode/terraPedia-db-redesign/data-query-app';
const port = 3001;
...
let logs = '';
let done = false;
const append = (d) => { logs += d.toString(); if (logs.length > 18000) logs = logs.slice(-18000); };
