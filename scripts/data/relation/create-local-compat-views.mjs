...
export const RELATION_COMPAT_VIEWS = {
  ...
  projectiles: {
    ...
    columns: ['id', 'source_id', 'internal_name', 'name', 'name_zh', 'ai_style', 'damage', 'knock_back', 'penetrate', 'time_left', 'width', 'height', 'scale', 'friendly', 'hostile', 'tile_collide', 'raw_json', 'status', 'deleted', 'created_at', 'updated_at'],
  },
  buffs: {
