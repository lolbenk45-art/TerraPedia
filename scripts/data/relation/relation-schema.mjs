...
function buildTableStatements() {
  ...
  UNIQUE KEY \`uk_item_buff_relations_record_key\` (\`record_key\`)
    ...
    `CREATE TABLE IF NOT EXISTS \`${RELATION_DATABASE_NAME}\`.\`npc_buff_relations\` (
  \`id\` BIGINT NOT NULL AUTO_INCREMENT,
  \`record_key\` CHAR(64) COLLATE utf8mb4_bin NOT NULL,
  \`npc_source_id\` INT DEFAULT NULL,
  \`npc_internal_name\` VARCHAR(255) DEFAULT NULL,
  ...
  ${AUDIT_COLUMNS},
  PRIMARY KEY (\`id\`),
  UNIQUE KEY \`uk_npc_buff_relations_record_key\` (\`record_key\`),
  KEY \`idx_npc_buff_relations_npc_source_id\` (\`npc_source_id\`),
  KEY \`idx_npc_buff_relations_buff_source_id\` (\`buff_source_id\`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;`,
