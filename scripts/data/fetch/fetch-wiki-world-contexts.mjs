...
export const WORLD_CONTEXT_SOURCE_PAGES = [
  ...
  { title: 'Rain', domain: 'weather' },
  { title: 'Sandstorm', domain: 'weather' },
  { title: 'Windy Day', domain: 'weather' },
  { title: 'Thunderstorm', domain: 'weather' },
  { title: 'Starfall', domain: 'event' },
  { title: 'Blood Moon', domain: 'event' },
  { title: 'Party', domain: 'event' },
  { title: 'Lantern Night', domain: 'event' },
  { title: 'Goblin Army', domain: 'event' },
  { title: 'Slime Rain', domain: 'event' },
  { title: "Old One's Army", domain: 'event' },
  { title: 'The Torch God', domain: 'event' },
  { title: 'Frost Legion', domain: 'event' },
  { title: 'Solar Eclipse', domain: 'event' },
  { title: 'Pirate Invasion', domain: 'event' },
  { title: 'Pumpkin Moon', domain: 'event' },
  { title: 'Frost Moon', domain: 'event' },
  { title: 'Martian Madness', domain: 'event' },
  { title: 'Lunar Events', domain: 'event' },
