...
const MANIFEST = [
  {
    ...
    notes: 'Feeds /admin/data-source-acceptance/overview relationHealth from the latest relation health report.',
  },
  {
  ...
  },
  {
    ...
    generatorCommand: 'node scripts/data/audit/image-asset-readiness-audit.mjs',
    writesDatabase: false,
    requiresDatabase: true,
