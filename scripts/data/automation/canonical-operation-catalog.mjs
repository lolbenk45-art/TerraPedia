...
export const CANONICAL_OPERATION_DATA_PATHS = Object.freeze({
  ...
  'canonical-crawler-v2-scheduler-t1-acceptance': Object.freeze([
    ...
    'data/wiki-crawler/normalized/boss-loot.bundle.json',
    'data/standardized-view/projectiles/part-0001.json',
    'data/standardized-view/buffs/part-0001.json',
    'data/generated/wiki-biomes.importable.latest.json',
    'data/wiki-crawler/canonical/npc/king-slime.latest.json',
  ]),
...
export const CANONICAL_OPERATION_ENTRYPOINTS = Object.freeze({
  ...
  'canonical-crawler-v2-items-t1-acceptance': 'scripts/data/monitor/crawler-queue-v2-scheduler-lifecycle.mjs',
