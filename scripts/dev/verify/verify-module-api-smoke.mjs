...
const checks = [
  ...
  { name: 'items.images', path: '/public/items/1/images', method: 'GET', auth: false, expectStatus: 200 },
  { name: 'items.sources', path: '/public/items/1/sources', method: 'GET', auth: false, expectStatus: 200 },
  { name: 'items.recipeTree', path: '/public/items/1/recipe-tree', method: 'GET', auth: false, expectStatus: 200 },
